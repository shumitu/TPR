    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            void Show()
            {
                ...
                Console.WriteLine("[2] Export to .json (whole Context)");
                Console.WriteLine("[3] Export to .txt (whole Context)");
                Console.WriteLine("[4] Import from .json (whole Context)");
                Console.WriteLine("[5] Import from .txt (whole Context)");
                Console.WriteLine("[6] Show data");
                Console.WriteLine("[7] Clear data");
                Console.WriteLine("[8] Create test classes and export to .txt");
                Console.WriteLine("[9] Import test classes from .txt");
